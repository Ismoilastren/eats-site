  ...
  return (
    <main className="min-h-screen bg-[#f6f6f3] px-4 py-10 text-gray-950">
      <section className="mx-auto max-w-3xl rounded-[32px] bg-white p-8 shadow-sm ring-1 ring-black/5">
        ...
        <div className="mt-8 flex h-16 w-16 items-center justify-center rounded-3xl bg-orange-500 text-white">
          <ShieldCheck size={32} />
        </div>
        ...
        <h1 className="mt-2 text-4xl font-black">Use the dedicated courier app</h1>
        <p className="mt-4 text-lg font-bold leading-8 text-gray-500">
          This website no longer exposes the legacy courier dashboard. Real
          couriers sign in with the Courier ID created in the admin panel, then
          accept and update deliveries from the Courier Expo app.
        </p>

        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          <a
            href="https://eats-adminn.vercel.app/couriers"
